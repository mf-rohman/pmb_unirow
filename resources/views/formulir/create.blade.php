<x-student-layout>
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative w-full bg-[#5D5FEF] rounded-2xl sm:rounded-[2rem] p-6 sm:p-8 mb-6 sm:mb-8 text-white overflow-hidden shadow-xl shadow-indigo-200">
            ...
            <div class="relative z-10 flex flex-col gap-4">
                <div>
                    ...
                    <h2 class="text-2xl sm:text-3xl font-bold leading-tight">Formulir Pendaftaran</h2>
                    <p class="text-indigo-100 text-sm mt-1">Isi data dengan benar sesuai Ijazah/KTP.</p>
                </div>
                
                <div class="px-4 sm:px-5 py-3 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl flex items-center gap-3 w-full sm:w-auto">
        ...
        <form action="{{ $formAction }}" method="POST" class="space-y-6 sm:space-y-8" 
            ...
            <div class="bg-white rounded-2xl sm:rounded-[2rem] p-6 sm:p-8 shadow-sm border border-gray-50">
                
                <div class="bg-white rounded-2xl sm:rounded-[2rem] p-6 sm:p-8 shadow-sm border border-gray-50 mb-6" x-data="{ viaGuru: false }">
                    <div class="flex items-center gap-3 mb-6 border-b border-gray-100 pb-4">
                        <div class="w-10 h-10 rounded-full bg-purple-50 flex items-center justify-center text-purple-500 font-bold flex-shrink-0">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z"></path></svg>
                        </div>
                        <h3 class="text-lg sm:text-xl font-bold text-gray-800">Jalur Khusus / Rekomendasi</h3>
                    </div>

                    <div class="space-y-4">
                        <label class="inline-flex items-start sm:items-center cursor-pointer select-none">
                            <input type="checkbox" x-model="viaGuru" class="rounded border-gray-300 text-[#5D5FEF] shadow-sm focus:border-[#5D5FEF] focus:ring focus:ring-[#5D5FEF] focus:ring-opacity-50 mt-1 sm:mt-0 flex-shrink-0">
                            <span class="ml-3 text-sm sm:text-base text-gray-700 font-bold">Saya mendaftar melalui Guru BK / Koordinator Sekolah</span>
                        </label>

                        <div x-show="viaGuru" x-transition.opacity.duration.300ms class="mt-4 p-4 sm:p-6 bg-purple-50 rounded-2xl border border-purple-100">
                            ...
                            <div class="relative w-full">
                                <input type="text" 
                                       ...
                                       class="w-full rounded-xl border-gray-200 uppercase tracking-[0.2em] font-bold text-center text-base sm:text-lg transition-all focus:ring-2 focus:ring-[#5D5FEF] focus:border-[#5D5FEF]"
                                       :class="{
                ...
                <div class="flex items-center gap-3 mb-6 border-b border-gray-100 pb-4">
                    <div class="w-10 h-10 rounded-full bg-indigo-50 flex items-center justify-center text-[#5D5FEF] font-bold flex-shrink-0">1</div>
                    <h3 class="text-lg sm:text-xl font-bold text-gray-800">Jalur & Program Studi</h3>
                </div>
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            <label class="relative cursor-pointer group">
                                ...
                                <div class="p-4 sm:p-5 rounded-2xl border-2 transition-all h-full"
                                     :class="selectedJalur == '{{ $jalur->id }}' ? 'border-[#5D5FEF] bg-indigo-50/50' : 'border-gray-100 bg-white hover:border-indigo-200'">

                                    <div class="flex items-center justify-between mb-2">
                                        <span class="font-bold text-sm sm:text-base text-gray-800">{{ $jalur->nama_jalur }}</span>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select name="program_studi_id_1" class="w-full rounded-xl border-gray-200 bg-gray-50 py-3 px-4 focus:ring-2 focus:ring-[#5D5FEF] focus:border-[#5D5FEF] text-sm sm:text-base" required>
                    ...
                    <template x-if="currentKategori && currentKategori.includes('Prestasi')">
                        <div class="p-4 sm:p-6 bg-yellow-50 rounded-2xl border border-yellow-100 transition-all">
                            <div class="flex items-start gap-3 mb-4">
                                <div class="p-2 bg-yellow-100 text-yellow-600 rounded-lg flex-shrink-0">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                                </div>
                                <div>
                                    <h4 class="font-bold text-sm sm:text-base text-yellow-800">Input Nilai Rapor</h4>
                                    <p class="text-xs sm:text-sm text-yellow-700 mt-1">Masukkan nilai rata-rata sesuai semester.</p>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                                <div>
                                    ...
                                    <input type="number" step="0.01" name="nilai_rapor_x_1" value="{{ old('nilai_rapor_x_1', $pendaftar->nilai_rapor_x_1 ?? '') }}" class="w-full rounded-lg border-gray-200 focus:ring-yellow-400 focus:border-yellow-400 text-sm" placeholder="00.00">
                                </div>
                                <div>
                                    <label class="block text-xs font-bold text-gray-600 mb-1">Kelas X Sem 2</label>
                                    <input type="number" step="0.01" name="nilai_rapor_x_2" value="{{ old('nilai_rapor_x_2', $pendaftar->nilai_rapor_x_2 ?? '') }}" class="w-full rounded-lg border-gray-200 focus:ring-yellow-400 focus:border-yellow-400 text-sm" placeholder="00.00">
                                </div>
                                <div>
                                    <label class="block text-xs font-bold text-gray-600 mb-1">Kelas XI Sem 1</label>
                                    <input type="number" step="0.01" name="nilai_rapor_xi_1" value="{{ old('nilai_rapor_xi_1', $pendaftar->nilai_rapor_xi_1 ?? '') }}" class="w-full rounded-lg border-gray-200 focus:ring-yellow-400 focus:border-yellow-400 text-sm" placeholder="00.00">
                                </div>
                                <div>
                                    <label class="block text-xs font-bold text-gray-600 mb-1">Kelas XI Sem 2</label>
                                    <input type="number" step="0.01" name="nilai_rapor_xi_2" value="{{ old('nilai_rapor_xi_2', $pendaftar->nilai_rapor_xi_2 ?? '') }}" class="w-full rounded-lg border-gray-200 focus:ring-yellow-400 focus:border-yellow-400 text-sm" placeholder="00.00">
                                </div>
                            </div>

                            <div class="mt-4">
                                 <label class="block text-xs font-bold text-gray-600 mb-1">Prestasi Non Akademik (Jika Ada)</label>
                                 <input type="text" name="prestasi_non_akademik" value="{{ old('prestasi_non_akademik', $pendaftar->prestasi_non_akademik ?? '') }}" class="w-full rounded-lg border-gray-200 focus:ring-yellow-400 focus:border-yellow-400 text-sm" placeholder="Contoh: Juara 1 Lomba Pidato Provinsi">
                            </div>
                        </div>
                    </template>

                    <template x-if="currentKategori && currentKategori.includes('Hafidz')">
                        <div class="p-4 sm:p-6 bg-green-50 rounded-2xl border border-green-100 transition-all">
                            <div class="flex items-start gap-3 mb-4">
                                ...
                                <div>
                                    <h4 class="font-bold text-sm sm:text-base text-green-800">Syarat Hafidz Qur'an</h4>
                                </div>
                            </div>
                    ...
                    <template x-if="currentKategori && (currentKategori.includes('UTBK') || currentKategori.includes('RPL'))">
                        <div class="p-4 sm:p-6 bg-blue-50 rounded-2xl border border-blue-100 transition-all">
                             <div class="flex items-start gap-3 mb-4">
                                <div class="p-2 bg-blue-100 text-blue-600 rounded-lg flex-shrink-0">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
                                </div>
                                <div>
                                    <h4 class="font-bold text-sm sm:text-base text-blue-800">Syarat Nilai UTBK</h4>
                                </div>
                            </div>
            ...
            <div class="bg-white rounded-2xl sm:rounded-[2rem] p-6 sm:p-8 shadow-sm border border-gray-50">
                <div class="flex items-center gap-3 mb-6 border-b border-gray-100 pb-4">
                    <div class="w-10 h-10 rounded-full bg-pink-50 flex items-center justify-center text-pink-500 font-bold flex-shrink-0">2</div>
                    <h3 class="text-lg sm:text-xl font-bold text-gray-800">Biodata Diri</h3>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                    <div class="lg:col-span-1">
                        ...
                        <input type="text" name="nama_lengkap" 
                               ...
                               class="w-full rounded-xl border-gray-200 bg-gray-50 py-3 px-4 focus:ring-2 focus:ring-[#5D5FEF] focus:border-[#5D5FEF] transition-all text-sm sm:text-base" required>
                    ...
                    <div>
                        ...
                        <select name="jenis_kelamin" class="w-full rounded-xl border-gray-200 bg-gray-50 py-3 px-4 focus:ring-2 focus:ring-[#5D5FEF] focus:border-[#5D5FEF] text-sm sm:text-base" required>
                    ...
                    <div>
                        ...
                        <select name="agama" class="w-full rounded-xl border-gray-200 bg-gray-50 py-3 px-4 focus:ring-2 focus:ring-[#5D5FEF] focus:border-[#5D5FEF] text-sm sm:text-base" required>
                    ...
                    <div>
                        ...
                        <input type="number" name="no_hp" 
                               ...
                               class="w-full rounded-xl border-gray-200 bg-gray-50 py-3 px-4 focus:ring-2 focus:ring-[#5D5FEF] focus:border-[#5D5FEF] text-sm sm:text-base" required>
                    ...
                    <div>
                        ...
                        <input type="email" value="{{ Auth::user()->email }}" 
                               class="w-full rounded-xl border-gray-200 bg-gray-200 py-3 px-4 text-gray-500 cursor-not-allowed text-sm sm:text-base" readonly>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl sm:rounded-[2rem] p-6 sm:p-8 shadow-sm border border-gray-50">
                <div class="flex items-center gap-3 mb-6 border-b border-gray-100 pb-4">
                    <div class="w-10 h-10 rounded-full bg-teal-50 flex items-center justify-center text-teal-500 font-bold flex-shrink-0">3</div>
                    <h3 class="text-lg sm:text-xl font-bold text-gray-800">Sekolah & Orang Tua</h3>
                </div>
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                    <div>
                        ...
                        <input type="text" name="asal_sekolah" 
                               ...
                               class="w-full rounded-xl border-gray-200 bg-gray-50 py-3 px-4 focus:ring-2 focus:ring-[#5D5FEF] focus:border-[#5D5FEF] text-sm sm:text-base" 
            ...
            <div class="bg-white rounded-2xl sm:rounded-[2rem] p-6 sm:p-8 shadow-sm border border-gray-50">
                <div class="flex items-center gap-3 mb-6 border-b border-gray-100 pb-4">
                    <div class="w-10 h-10 rounded-full bg-blue-50 flex items-center justify-center text-blue-500 font-bold flex-shrink-0">4</div>
                    <h3 class="text-lg sm:text-xl font-bold text-gray-800">Alamat Domisili</h3>
                </div>

                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                    <div class="lg:col-span-2">
                        <label class="block text-sm font-bold text-gray-700 mb-2">Alamat Lengkap</label>
                        <textarea name="alamat_lengkap" rows="2" class="w-full rounded-xl border-gray-200 bg-gray-50 py-3 px-4 focus:ring-2 focus:ring-[#5D5FEF] focus:border-[#5D5FEF] text-sm sm:text-base" placeholder="Nama Jalan, No. Rumah, Gang..." required>{{ old('alamat_lengkap', $pendaftar->alamat_lengkap ?? '') }}</textarea>
                    </div>
                    <div class="flex gap-4">
                        <div class="w-1/2">
                            <label class="block text-sm font-bold text-gray-700 mb-2">RT</label>
                            <input type="number" name="rt" class="w-full rounded-xl border-gray-200 bg-gray-50 py-3 px-4 focus:ring-2 focus:ring-[#5D5FEF] focus:border-[#5D5FEF] text-sm sm:text-base">
                        </div>
                        <div class="w-1/2">
                            <label class="block text-sm font-bold text-gray-700 mb-2">RW</label>
                            <input type="number" name="rw" class="w-full rounded-xl border-gray-200 bg-gray-50 py-3 px-4 focus:ring-2 focus:ring-[#5D5FEF] focus:border-[#5D5FEF] text-sm sm:text-base">
                        </div>
                    </div>

                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-2">Provinsi</label>
                        <select name="province_id" x-model="selectedProvince" @change="fetchRegencies()" class="w-full rounded-xl border-gray-200 bg-gray-50 py-3 px-4 focus:ring-2 focus:ring-[#5D5FEF] focus:border-[#5D5FEF] text-sm sm:text-base">
                    ...
                    <div>
                        ...
                        <select name="regency_id" x-model="selectedRegency" @change="fetchDistricts()" :disabled="!selectedProvince" class="w-full rounded-xl border-gray-200 bg-gray-50 py-3 px-4 focus:ring-2 focus:ring-[#5D5FEF] focus:border-[#5D5FEF] text-sm sm:text-base">
                    ...
                    <div>
                        ...
                        <select name="district_id" x-model="selectedDistrict" @change="fetchVillages()" :disabled="!selectedRegency" class="w-full rounded-xl border-gray-200 bg-gray-50 py-3 px-4 focus:ring-2 focus:ring-[#5D5FEF] focus:border-[#5D5FEF] text-sm sm:text-base">
                    ...
                    <div>
                        ...
                        <select name="village_id" :disabled="!selectedDistrict" class="w-full rounded-xl border-gray-200 bg-gray-50 py-3 px-4 focus:ring-2 focus:ring-[#5D5FEF] focus:border-[#5D5FEF] text-sm sm:text-base">
            ...
            <div class="flex flex-col sm:flex-row justify-end gap-3 sm:gap-4 pt-4 pb-12">
                <button type="button" onclick="history.back()" class="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 rounded-xl border border-gray-200 text-gray-600 font-bold hover:bg-gray-50 transition text-sm sm:text-base">
                    Batal
                </button>
                <button type="submit" class="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 rounded-xl bg-gray-900 text-white font-bold hover:bg-black transition shadow-lg hover:shadow-xl transform hover:-translate-y-1 text-sm sm:text-base">
